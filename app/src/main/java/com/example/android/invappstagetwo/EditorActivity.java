...
public class EditorActivity extends AppCompatActivity implements
    ...
    private EditText mSupplierNrEditText;

    private boolean mItemHasChanged = false;

    //checks if valid entries
    boolean all_fields_valid = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSupplierNrEditText = (EditText) findViewById(R.id.edit_supplier_nr);
            ...
            public void onClick(View arg0) {
                if (mQuantityEditText.getText() != null) { //if nothing in there
                    ...
                    if (quantityInt > 0) {
                        ...
                        Toast.makeText(getApplicationContext(), (R.string.no_negative_values), Toast.LENGTH_SHORT).show();
                    }
                } else {
        ...
        plus_button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                if(mQuantityEditText.getText()!=null) {
                    ...
                    int quantityInt = Integer.parseInt(quantityString);
                    quantityInt++;
                    quantityString = valueOf(quantityInt);
        ...
        Button contact_supplier = (Button) findViewById(R.id.contact_supplier);
        contact_supplier.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                String supplierNr = mSupplierNrEditText.getText().toString().trim();
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + supplierNr));
        ...
        mSupplierNrEditText.setOnTouchListener(mTouchListener);
    }
    ...
    private void saveItem() {
        ...
        String supplierNrString = mSupplierNrEditText.getText().toString().trim();
        ...
        // check if smth was entered in the name field
        ...
        if (TextUtils.isEmpty(supplierString)) {
            ...
            values.put(ItemEntry.COLUMN_SUPPLIER, supplierString);
        }

        if (TextUtils.isEmpty(supplierNrString)) {
            // If the not complete not save items
            Toast.makeText(this, getString(R.string.empty_field),
                    Toast.LENGTH_SHORT).show();
        } else {
            values.put(ItemEntry.COLUMN_SUPPLIER_NR, supplierNrString);
        }

        //checks if fields r valid, if yes exit activity otherwise stay
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int supplierNrColumnIndex = cursor.getColumnIndex(ItemEntry.COLUMN_SUPPLIER_NR);
            ...
            mSupplierNrEditText.setText(supplierNr);
        }
    }
